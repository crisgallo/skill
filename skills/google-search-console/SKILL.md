...
11. **Tipi di ricerca:** Web, Immagini, Video, Notizie sono filtri del rapporto Risultati di ricerca; **dal 24/09/2026 "Web" si divide in "Text-based" e "Multimodal"**: multimodale = risultati web da una ricerca fatta con un'immagine (Lens, Cerchia e cerca su Android, immagine caricata in Google, "Cerca immagine" dal tasto destro di Chrome); per quel traffico **la dimensione Query non esiste** e i dati sono nuovi, non riclassificati ([blog Search Central 24/09/2026](https://developers.google.com/search/blog/2026/09/web-multimodal-in-sc), [7576553](https://support.google.com/webmasters/answer/7576553?hl=en)). Un e-commerce con foto prodotto riconoscibili vede impressioni che prima non contava; **Discover e Google News hanno rapporti propri** che compaiono solo con "un numero minimo di impressioni negli ultimi 3 mesi" ([10268906](https://support.google.com/webmasters/answer/10268906?hl=en)). La posizione media nelle immagini si conta "da sinistra a destra, poi dall'alto in basso" ([7042828](https://support.google.com/webmasters/answer/7042828?hl=en)).
...
- **24/09/2026, filtro multimodale**: nel rapporto Rendimento (Search e report IA generativa) il tipo di ricerca Web si divide in Text-based e Multimodal; senza query, con pagine, paesi, dispositivi, date (sez. 2, punto 11). Nello stesso giorno Google ha avviato il **September 2026 spam update** (dalle 09:15 PDT, globale, tutte le lingue, fino a due settimane; [Search Status Dashboard](https://status.search.google.com/incidents/XhUDXP7A67iHCD2kmbVu)): un calo dal 24/09 su un sito con contenuti a rischio si legge prima lì che nel rapporto Rendimento.
